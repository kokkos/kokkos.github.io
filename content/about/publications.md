...
To ensure proper attribution in your work, please refer to our [Citing Kokkos]({{% ref "about/citing-kokkos" %}}) page for a list of recommended citations.
...
| 2022 | Kernels | [Parallel, Portable Algorithms for Distance-2 Maximal Independent Set and Graph Coarsening](https://doi.org/10.1109/IPDPS53621.2022.00035) |
...
| 2021 | Kernels | [Two-Stage Gauss–Seidel Preconditioners and Smoothers for Krylov Solvers on a GPU cluster](https://doi.org/10.48550/arXiv.2104.01196) |
| 2020 | Kernels | [Performance Portable Supernode-based Sparse Triangular Solver for Manycore Architectures](https://doi.org/10.1145/3404397.3404428) |
| 2018 | Kernels | [Multithreaded sparse matrix-matrix multiplication for many-core and GPU architectures](https://doi.org/10.1016/j.parco.2018.06.009) |
| 2018 | Tools | [Profiling and debugging support for the kokkos programming model](https://doi.org/10.1007/978-3-030-02465-9_53) |
| 2016 | Kernels | [Parallel Graph Coloring for Manycore Architectures](https://doi.org/10.1109/IPDPS.2016.54) |
