...
The following is a partial list of applications leveraging Kokkos for Performance Portability. The "Status" field indicates whether the application is using Kokkos in production runs yet, or whether the project is in the process of porting over to Kokkos or developing its capabilities from scratch.
