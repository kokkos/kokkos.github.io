...
*By Carl Pearson (Sandia National Laboratories, Center for Computing Research), Ian Bogle (AMD, El Capitan Center of Excellence), Jonathan Madsen (AMD, Tech Lead for rocprof), Kevin Huck (AMD, El Capitan Center of Excellence)*
...
```bash
# Kokkos commit: 21490d0645bbf3972bdeb1028e453b4b2e774f41
git clone --branch develop https://github.com/kokkos/kokkos.git

# Kokkos Kernels commit: 194903ac7fac138ad871bf5d9d4b45d0aa257dfa
git clone --branch develop https://github.com/kokkos/kokkos-kernels.git
```
